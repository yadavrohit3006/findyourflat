...
export function FormLocationPicker({ onPick, error, initialQuery, defaultPicked }: FormLocationPickerProps) {
  const [query, setQuery] = useState(defaultPicked?.address ?? initialQuery ?? '');
